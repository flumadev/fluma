<main>
        ...
        <div class="container">
            ...
            <div class="flex max-md:flex-col mt-20 relative">
                <div class="space-y-7 md:w-1/3 relative z-20 md:mr-16 max-md:mb-8">
                    ...
                    <p>Criamos sites e aplicativos modernos, rápidos e seguros para atender às necessidades específicas
                        do seu negócio que o software de prateleira não consegue.</p>
                </div>
    ...
    <section class="list-grid section relative overflow-hidden ">
        <div class="container max-w-screen-lg pb-32">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-x-36 lg:gap-y-28">
                <div class="">
                    <svg class="fill-current h-12 w-12 mb-8 text-gray-400" viewBox="0 0 512 512"
                    ...
                    <h3 class="title mb-4">Sites e aplicativos modernos &amp; rápidos</h3>
                    <p class="relative z-10 text-gray-400/60" style="max-width: 340px">Construímos sites modernos e
                        rápidos para atender às necessidades específicas do seu negócio que o software de prateleira não
                        consegue. Nossas escolhas de tecnologia que tornam isso possível estão enraizadas na crença de
                        que move a Web para frente, tornando-a segura, mais rápida e mais fácil de escalar. Nossas
                        estruturas de desenvolvimento front-end são compostas por Next.js, Svelte Kit e Astro, para
                        citar alguns.</p> <span
                        class="font-mono text-white mt-4 block text-sm">UI, UX, Headless, APIs, Next.js, Svelte</span>
                    <a href="/modern-websites-and-apps" class="button button-primary mt-8">Websites &amp; Apps</a></div>
                <div class="">
                    <svg class="fill-current h-12 w-12 mb-8 text-gray-400" viewBox="0 0 448 512"
                         xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" role="img">
    ...
    <section class="list-grid section relative overflow-hidden">
        ...
        <div class="container max-w-screen-lg"><h2
                class="title text-lg sm:text-4xl text-center mt-8 mb-12 md:mb-20 lg:mb-36">Nosso
            processo.</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-x-36 lg:gap-y-28">
                <div>
                    ...
                    <h3 class="title mb-4">Levantamento de requisitos</h3>
                    <p style="max-width: 340px" class="relative z-10 text-gray-400/60">Colocamos nossa capacidade de
                        ouvir em primeiro lugar. Nossos analistas de negócios e profissionais sentam com você para ouvir
                        sua necessidade.</p></div>
                <div class="">
