        ...
        <div class="container max-w-screen-lg pb-32">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-x-36 lg:gap-y-28">
                <div class="">
                    ...
                    <p class="relative z-10 text-gray-400" style="max-width: 340px">Construímos sites modernos e
                ...
                <div class="">
                    ...
                    <p class="relative z-10 text-gray-400" style="max-width: 340px">O ecommerce teve um aumento
                ...
                <div class="">
                    ...
                    <p class="relative z-10 text-gray-400" style="max-width: 340px">Construímos aplicativos
        ...
        <div class="container max-w-screen-lg"><h2
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-x-36 lg:gap-y-28">
                <div>
                    ...
                    <p style="max-width: 340px" class="relative z-10 text-gray-400">Colocamos nossa capacidade de
                ...
                <div class="">
                    ...
                    <p style="max-width: 340px" class="relative z-10 text-gray-400">Usamos o que aprendemos na etapa
                ...
                <div class="">
                    ...
                    <p style="max-width: 340px" class="relative z-10 text-gray-400">É aqui que identificamos uma
                ...
                <div class="">
                    ...
                    <p style="max-width: 340px" class="relative z-10 text-gray-400">Iniciamos nosso planejamento e
                ...
                <div class="">
                    ...
                    <p style="max-width: 340px" class="relative z-10 text-gray-400">Este é o passo principal. Usamos
                ...
                <div class="">
                    ...
                    <p style="max-width: 340px" class="relative z-10 text-gray-400">Perto da conclusão, validamos e
                ...
                <div class="">
                    ...
                    <p style="max-width: 340px" class="relative z-10 text-gray-400">Parabéns! Você acabou de comprar
