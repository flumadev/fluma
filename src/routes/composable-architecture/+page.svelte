...
<main>
    <header class="section relative lg:pb-48 mt-64">
        <div class="container">
            <h1 class="title text-lg sm:text-2xl md:text-4xl md:font-light max-w-screen-md mb-20">
                Fluma</h1>
            <div class="flex max-md:flex-col relative"><img
                    ...
                    src="https://images.prismic.io/monogram/370899cf-f33a-46a4-a197-eb8efd51949c_bulletin-board.jpg?auto=compress,format"
                    alt="bulletin board" width="990" height="660" sizes="(min-width: 2560px) 2560px, 100vw"
                    srcset="https://images.prismic.io/monogram/370899cf-f33a-46a4-a197-eb8efd51949c_bulletin-board.jpg?auto=compress%2Cformat&amp;quality=75&amp;width=512 512w,https://images.prismic.io/monogram/370899cf-f33a-46a4-a197-eb8efd51949c_bulletin-board.jpg?auto=compress%2Cformat&amp;quality=75&amp;width=768 768w,https://images.prismic.io/monogram/370899cf-f33a-46a4-a197-eb8efd51949c_bulletin-board.jpg?auto=compress%2Cformat&amp;quality=75&amp;width=1024 1024w,https://images.prismic.io/monogram/370899cf-f33a-46a4-a197-eb8efd51949c_bulletin-board.jpg?auto=compress%2Cformat&amp;quality=75&amp;width=1920 1920w,https://images.prismic.io/monogram/370899cf-f33a-46a4-a197-eb8efd51949c_bulletin-board.jpg?auto=compress%2Cformat&amp;quality=75&amp;width=2560 2560w"
                    draggable="true" loading="eager">
                <div class="space-y-7 md:w-1/3 relative z-20 md:mr-16 max-md:mb-8">
                    <div class="title md:text-xl"><h2>O que é Composable architecture?</h2></div>
                    <p class="">Composable architecture é baseada na ideia de construir sites e aplicativos modulares,
                        partes independentes que você pode combinar para formar um sistema completo integrado por meio
                        de APIs.</p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-x-36 lg:gap-y-28">
                ...
                <div class=""><h3 class="title mb-4">Composable vs. monoliths</h3>
                    <p style="max-width: 340px" class="relative z-10 text-gray-400">Composable architecture offers a
                        ...
                        building a complete stack of products from a single codebase. This approach is not only more
