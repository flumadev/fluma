    ...
    <header class="container h-[80svh] ">
        ...
        <div class="flex flex-col-reverse md:flex-row h-full items-center justify-center ">
            <div>
                ...
                <p class="max-w-[420px]">Agência digital especializada em e-commerce,
                    desenvolvimento web e aplicativos.</p>
            </div>
        </div>
    </header>
    <section>
            ...
            <div class="flex flex-wrap justify-center items-center gap-2 rounded-[200px] xl:rounded-full sm:p-6">
                ...
                <a href="/service"
                   class="w-full xl:w-1/3 max-w-[300px] px-8 py-12 md:px-12 text-white aspect-square flex flex-col items-center justify-center rounded-full text-center group hover:bg-white/10 hover:text-white transition-colors duration-300 ease">
                    ...
                    <h3 class="title text-xl mb-4">Serviço.</h3>
                    <p class="text-sm text-m-500 group-hover:text-white leading-6 max-w-[220px] transition-colors duration-300 ease">
                        Nós fornecemos um serviço do qual nos orgulhamos. Não paramos até que tenhamos feito
                        o nosso melhor.</p>
                </a>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-4 sm:gap-x-6 lg:gap-x-16">
                <a href="https://www.myshinee.com.br/"
                   class="flex flex-col items-start group justify-center p-4 sm:p-6 md:py-12 border-l border-white/10 hover:border-blue-500 transition-colors duration-300">
                    <img class="select-none object-contain w-36" src="clients/myshinee.png" alt="My Shinee"/>
                </a>
